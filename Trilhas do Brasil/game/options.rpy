...
define config.name = _("Trilhas do Brasil")
...
define build.name = "TrilhasdoBrasil"
...
#Adiciona o canal "textSound" para o som do texto nas falas do jogo.
init python:
...
define config.save_directory = "TrilhasdoBrasil-1724201845"
